      ...
      <div class="r-content">
        ...
        <div class="readnotice-content">
          ...
          <div class="xinxi">
            ...
            <a
              href="https://www.jianshu.com/u/0cbdef4e8ecc"
              target="“_blank”"
            >&ensp;&ensp;我的简书</a>
          </div>
          <div class="xinxi">
            <img src="../assets/img/qq.png" alt />&ensp;&ensp;1807856155
          </div>
          <div class="xinxi">
            <img src="../assets/img/mail.png" alt /> &ensp;&ensp;1807856155@qq.com
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    getcolumn() {
      this.$axios({
        ...
        res => {
          this.serieslist = res.data.result;
        },
        err => {
          console.log(err);
        }
...
.readtime-content,
.allTag,
.readmore-content .readmore-header {
  margin-top: 14px;
  margin-bottom: 0px;
}
.left {
